  ...
  return (
    <Card sx={{ maxWidth: 345, marginLeft: "1rem",  top: 100, borderRadius: 5, minWidth: 345, }}>
      ...
      <CardActions sx={{ color: 'white', backgroundColor: '#36393F'}}>
        <Button variant="contained" sx={{ color: 'white', backgroundColor: '#7289DA', left: 10, fontFamily: 'Montserrat', fontWeight: 700, bottom:5 }}>Order Now</Button>
        <Button variant="contained" sx={{ color: 'white', backgroundColor: 'red', left: 40, fontFamily: 'Montserrat', fontWeight: 700, bottom:5 }}>Remove Order</Button>
